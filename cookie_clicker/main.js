...
Game.Launch=function()
{
	...
	'<div class="listing">&bull; when hovering over おばあちゃんs, you can now see their names and ages</div>'+
	...
	'<div class="listing">&bull; new cookies, ミルク flavors and achievements</div>'+
	...
	'<div class="listing">&bull; new ミルク, new kittens, new dragon aura, new cookie, new upgrade tier</div>'+
	...
	'<div class="listing">&bull; changed unlock levels and prices for some カーソル upgrades</div>'+
	...
	'<div class="listing">&bull; also added a separate option for displaying カーソル</div>'+
	...
	'<div class="listing">&bull; the おばあちゃんpocalypse now spawns wrinklers, hideous elderly creatures that damage your CpS when they reach your big cookie. Thankfully, you can click on them to make them explode (you\'ll even gain back the cookies they\'ve swallowed - with interest!).</div>'+
	...
	'<div class="listing">&bull; カーソル now just plain disappear with Fancy Graphics off, I might add a proper option to toggle only the カーソル later</div>'+
	...
	'<div class="listing">&bull; カーソル now stop moving if Fancy Graphics is turned off</div>'+
	...
	'<div class="listing">&bull; new ミルク tier</div>'+
	...
	'<div class="listing">&bull; each おばあちゃん upgrade now requires 15 of the matching building</div>'+
	'<div class="listing">&bull; the dreaded bottom カーソル has been fixed with a new カーソル display style</div>'+
	...
	'<div class="listing">&bull; raspberry juice is now named raspberry ミルク, despite raspberry juice being delicious and going unquestionably well with cookies</div>'+
	'<div class="listing">&bull; HOTFIX : カーソル now click; fancy graphics button renamed; cookies amount now more visible against カーソル</div>'+
	...
	'<div class="listing">&bull; added a way to permanently stop the おばあちゃんpocalypse</div>'+
	'<div class="listing">&bull; Elder Pledge price is now capped</div>'+
	'<div class="listing">&bull; One Mind and other おばあちゃん research upgrades are now a little more powerful, if not 100% accurate</div>'+
	'<div class="listing">&bull; "golden" cookie now appears again during おばあちゃんpocalypse; Elder Pledge-related achievements are now unlockable</div>'+
	
	'</div><div class="subsection update">'+
	'<div class="title">31/08/2013 - too many おばあちゃんs</div>'+
	'<div class="listing">&bull; the おばあちゃんpocalypse is back, along with more おばあちゃん types</div>'+
	...
	'<div class="listing">&bull; added achievements (and ミルク)</div>'+
	...
	'<div class="listing">&bull; tweaked a couple カーソル upgrades</div>'+
	...
	'<div class="listing">&bull; added CpS for カーソル</div>'+
	...
	Game.Init=function()
	{
		...
		l('versionNumber').innerHTML='v. '+Game.version+'<div id="httpsSwitch" style="カーソル:pointer;display:inline-block;background:url(img/'+(Game.https?'lockOn':'lockOff')+'.png);width:16px;height:16px;position:relative;top:4px;left:0px;margin:0px -2px;"></div>'+(Game.beta?' <span style="color:#ff0;">beta</span>':'');
		...
		Game.ミルクProgress=0;//you gain a little bit for each achievement. Each increment of 1 is a different ミルク displayed.
		Game.ミルクH=Game.ミルクProgress/2;//ミルク height, between 0 and 1 (although should never go above 0.5)
		Game.ミルクHd=0;//ミルク height display
		Game.ミルクType=0;//custom ミルク
		...
		Game.bg='';//background (おばあちゃんs and such)
		...
		Game.DefaultPrefs=function()
		{
			...
			Game.prefs.customおばあちゃんs=1;//if true, show patreon names for おばあちゃんs
		...
		{
			Game.Notify('セーブデータをバックアップしよう！','久しぶり! 念のため、クッキークリッカーの保存を時々バックアップしておくことがいいってことを教えておくよ。<br>そうそう、どうやってやるかというと、設定から"文字セーブデータを取得"とか"ファイルにセーブ"とか押すとできるよ!<div class="line"></div><a style="float:right;" onclick="Game.prefs.showBackupWarning=0;==CLOSETHIS()==">(多分)今後一切出てこなくなるボタン</a>',[25,7]);
		}
		...
		{
			Game.Prompt('<h3>ベーカリーに名を授ける(英語のみ)</h3><div class="block" style="text-align:center;">ベーカリーに名前を授けよう。名前はどうする？(日本語不可)</div><div class="block"><input type="text" style="text-align:center;width:100%;" id="bakeryNameInput" value="'+Game.bakeryName+'"/></div>',[['確定','if (l(\'bakeryNameInput\').value.length>0) {Game.bakeryNameSet(l(\'bakeryNameInput\').value);Game.Win(\'What\\\'s in a name\');Game.ClosePrompt();}'],['ランダム','Game.bakeryNamePromptRandom();'],'やっぱいいや']);
		...
		Game.おばあちゃんNames=['ばーちゃん1','ばーちゃん2','ばーちゃん3','ばーちゃん4','ばーちゃん5','ばーちゃん6','ばーちゃん7','ばーちゃん8','ばーちゃん9','ばーちゃん10','ばーちゃん11','ばーちゃん12','ばーちゃん13','ばーちゃん14','ばーちゃん15','ばーちゃん16','ばーちゃん17','ばーちゃん18','ばーちゃん19','ばーちゃん20','ばーちゃん21','ばーちゃん22','ばーちゃん23','ばーちゃん24','ばーちゃん25','ばーちゃん26','ばーちゃん27','ばーちゃん28','ばーちゃん29','ばーちゃん30','ばーちゃん31','ばーちゃん32','ばーちゃん33','ばーちゃん34','ばーちゃん35','ばーちゃん36','ばーちゃん37','ばーちゃん38','ばーちゃん39','ばーちゃん40','れあばーちゃん(20分の1)','れあばーちゃん(20分の1)','伝説のばーちゃん(40分の1)','ばーちゃん41'];
		Game.customおばあちゃんNames=[];
		Game.heralds=0;
		...
		Game.GrabDataResponse=function(response)
		{
			...
			*/
			...
			try{
				...
				if (typeof r['おばあちゃん']!=='undefined' && r['おばあちゃん']!='')
				{
					Game.customおばあちゃんNames=r['おばあちゃん'].split('|');
					Game.customおばあちゃんNames=Game.customおばあちゃんNames.filter(function(el){return el!='';});
				}
		...
		Game.attachTooltip(l('topbarkonnyaku'),'<div style="padding:8px;width:250px;text-align:center;">このゲームはCookie Clickerの改造版です。<br>こんにゃくver.作成者：@konnyaku1223(twitter)</div>','this');
		Game.attachTooltip(l('topbarOrteil'),'<div style="padding:8px;width:250px;text-align:center;">本家様のサイトです。<br>他のゲームも遊べるっぽいです</div>','this');
		Game.attachTooltip(l('topbarDashnet'),'<div style="padding:8px;width:250px;text-align:center;">本家様のホームページです。</div>','this');
		Game.attachTooltip(l('topbarTwitter'),'<div style="padding:8px;width:250px;text-align:center;">本家様の*Twitter*です。Xとも言うらしい</div>','this');
		...
		Game.attachTooltip(l('topbarcheat2'),'<div style="padding:8px;width:250px;text-align:center;">クッキー100万枚増やしちゃう。<br><b>こんにゃくver.の追加要素</b></div>','this');
		Game.attachTooltip(l('topbarcheat1'),'<div style="padding:8px;width:250px;text-align:center;">ゲームを一瞬でおもんなくする。<br><b>こんにゃくver.の追加要素</b></div>','this');
		...
		Game.ExportSave=function()
		{
			...
			Game.Prompt('<h3>セーブデータを文字にする</h3><div class="block">ほい、セーブデータやで。<br>なくさないように保存してね</div><div class="block"><textarea id="textareaPrompt" style="width:100%;height:128px;" readonly>'+Game.WriteSave(1)+'</textarea></div>',['閉じる']);//prompt('Copy this text and keep it somewhere safe!',Game.WriteSave(1));
			l('textareaPrompt').focus();l('textareaPrompt').select();
		}
		Game.ImportSave=function()
		{
			Game.Prompt('<h3>セーブデータ読み込み</h3><div class="block">保存の時に出てきたなっがい文字列ここに入れたら読み込めるよ。</div><div class="block"><textarea id="textareaPrompt" style="width:100%;height:128px;"></textarea></div>',[['行けぇー俺のスーパークッキークリッカーセーブデータストリングロード！！','if (l(\'textareaPrompt\').value.length>0) {Game.ImportSaveCode(l(\'textareaPrompt\').value);Game.ClosePrompt();}'],'やっぱいいや']);//prompt('Please paste in the text that was given to you on save export.','');
		...
		Game.WriteSave=function(type)
		{
			...
			(type==3?'\n	ミルク type : ':'')+parseInt(Math.floor(Game.ミルクType))+';'+
			...
			else
			{
				if (Game.useLocalStorage)
				{
					...
					else
					{
						...
						{
							if (Game.prefs.popups) Game.Popup('セーブできなかった...<br>ファイルに保存したほうがいいかも');
							else Game.Notify('セーブできなかった...','ファイルに保存したほうがいいかも');
						}
						else if (document.hasFocus())
						{
							if (Game.prefs.popups) Game.Popup('Game saved');
							else Game.Notify('セーブデータを保存したよ','','',1,1);
						}
					}
				}
				else//legacy system
			...
			if (str!='')
			{
				...
				if (str!='')
				{
					...
					if (version>=1)
					{
						...
						Game.prefs.ミルク=spl[4]?parseInt(spl[4]):1;
						...
						Game.prefs.カーソル=spl[7]?parseInt(spl[7]):0;
						...
						Game.prefs.customおばあちゃんs=spl[19]?parseInt(spl[19]):1;
						...
						Game.ミルクType=spl[7]?parseInt(spl[7]):0;
						...
						if (Game.ミルクType==-1) Game.ミルクType=0;
						...
						{
							if (Game.Has('Starter kit')) Game.Objects['カーソル'].free=10;
							if (Game.Has('Starter kitchen')) Game.Objects['おばあちゃん'].free=5;
						}
						...
						if (Game.mobile || Game.Has('Perfect idling') || Game.Has('Twin Gates of Transcendence'))
						{
							...
							if (amount>0)
							{
								...
								else Game.Notify('おかえり!','なんと！<b>'+Beautify(amount)+'</b> クッキー'+(Math.floor(amount)==1?'':'s')+' をあなたがいない間に獲得したよ。<br>('+Game.sayTime(timeOfflineOptimal*Game.fps,-1)+' at '+Math.floor(percent)+'% CpS'+(timeOfflineReduced?', plus '+Game.sayTime(timeOfflineReduced*Game.fps,-1)+' at '+(Math.floor(percent*10)/100)+'%':'')+'.)',[Math.floor(Math.random()*16),11]);
								Game.Earn(amount);
							}
						}
		...
		Game.Reset=function(hard)
		{
			...
			if (!hard)
			{
				if (Game.ascensionMode!=1)
				{
					...
					if (Game.Has('Starter kit')) Game.Objects['カーソル'].getFree(10);
					if (Game.Has('Starter kitchen')) Game.Objects['おばあちゃん'].getFree(5);
				}
			}
			...
			if (hard)
			{
				...
				else Game.Notify('ゲームのリセット完了','さようなら、クッキーたち。',[21,6],6);
			}
		}
		Game.HardReset=function(bypass)
		{
			if (!bypass)
			{
				Game.Prompt('<h3>セーブデータ削除</h3><div class="block">(多分)頑張ってきたデータ消しちゃっていいんすかー？<br><small>マジでデータ消すんか？(´^ω^｀)<br>実績とか全部消えるよ？いいんすか？<br>***最重要：何しても戻せないよ？***</small></div>',[['戻せなくてもいいからセーブデータを消す','Game.ClosePrompt();Game.HardReset(1);'],'やっぱいいや']);
			}
			else if (bypass==1)
			{
				Game.Prompt('<h3>最終警告 - セーブデータ削除</h3><div class="block">おうおう,ガチで消すんやな？, <b><i>本当に このデータ消すんか？元に戻せないぞ？</i></b><br><small>「警告しなかったじゃないか」なんて言わせないからな！</small></div>',[['自己責任でいいから消す','Game.ClosePrompt();Game.HardReset(2);'],'やっぱりやめます']);
			}
			else
			{
				for (var i in Game.AchievementsById)
		...
		Game.computeLumpTimes=function()
		{
			...
			if (Game.Has('Sugar aging process')) Game.lumpRipeAge-=6000*Math.min(600,Game.Objects['おばあちゃん'].amount);//capped at 600 おばあちゃんs
		...
		Game.mouseCps=function()
		{
			...
			//if (Game.hasAura('Dragon カーソル')) mult*=1.05;
			mult*=1+Game.auraMult('Dragon カーソル')*0.05;
		...
		Game.CalculateGains=function()
		{
			...
			Game.ミルクProgress=Game.AchievementsOwned/25;
			var ミルクMult=1;
			if (Game.Has('Santa\'s ミルク and cookies')) ミルクMult*=1.05;
			//if (Game.hasAura('Breath of ミルク')) ミルクMult*=1.05;
			ミルクMult*=1+Game.auraMult('Breath of ミルク')*0.05;
			if (Game.hasGod)
			{
				var godLvl=Game.hasGod('mother');
				if (godLvl==1) ミルクMult*=1.1;
				else if (godLvl==2) ミルクMult*=1.05;
				else if (godLvl==3) ミルクMult*=1.03;
			}
			ミルクMult*=Game.eff('ミルク');
			
			var catMult=1;
			
			if (Game.Has('Kitten helpers')) catMult*=(1+Game.ミルクProgress*0.1*ミルクMult);
			if (Game.Has('Kitten workers')) catMult*=(1+Game.ミルクProgress*0.125*ミルクMult);
			if (Game.Has('Kitten engineers')) catMult*=(1+Game.ミルクProgress*0.15*ミルクMult);
			if (Game.Has('Kitten overseers')) catMult*=(1+Game.ミルクProgress*0.175*ミルクMult);
			if (Game.Has('Kitten managers')) catMult*=(1+Game.ミルクProgress*0.2*ミルクMult);
			if (Game.Has('Kitten accountants')) catMult*=(1+Game.ミルクProgress*0.2*ミルクMult);
			if (Game.Has('Kitten specialists')) catMult*=(1+Game.ミルクProgress*0.2*ミルクMult);
			if (Game.Has('Kitten experts')) catMult*=(1+Game.ミルクProgress*0.2*ミルクMult);
			if (Game.Has('Kitten consultants')) catMult*=(1+Game.ミルクProgress*0.2*ミルクMult);
			if (Game.Has('Kitten assistants to the regional manager')) catMult*=(1+Game.ミルクProgress*0.175*ミルクMult);
			if (Game.Has('Kitten marketeers')) catMult*=(1+Game.ミルクProgress*0.15*ミルクMult);
			if (Game.Has('Kitten analysts')) catMult*=(1+Game.ミルクProgress*0.125*ミルクMult);
			if (Game.Has('Kitten executives')) catMult*=(1+Game.ミルクProgress*0.115*ミルクMult);
			if (Game.Has('Kitten angels')) catMult*=(1+Game.ミルクProgress*0.1*ミルクMult);
			if (Game.Has('Fortune #103')) catMult*=(1+Game.ミルクProgress*0.05*ミルクMult);
			...
			'golden':{
				...
				popFunc:function(me)
				{
					...
					else if (choice=='blab')//sorry (it's really rare)
					{
						...
						'おばあちゃん kisses 23% stingier for 45 seconds!',
						'Thanks for clicking!',
		...
		Game.goldenCookieBuildingBuffs={
			'カーソル':['High-five','Slap to the face'],
			'おばあちゃん':['Congregation','Senility'],
		...
		Game.UpdateMenu=function()
		{
			...
			if (Game.onMenu!='')
			{
				...
				//str+='<div style="position:absolute;top:8px;right:8px;カーソル:pointer;font-size:16px;" '+Game.clickStr+'="Game.ShowMenu();">X</div>';
			}
			if (Game.onMenu=='prefs')
			{
				str+='<div class="section">オプション</div>'+
				'<div class="subsection">'+
				'<div class="title">セーブ系</div>'+
				'<div class="listing"><a class="option" '+Game.clickStr+'="Game.toSave=true;PlaySound(\'snd/tick.mp3\');">セーブする</a><label>今すぐにセーブできるよ (ちなこのゲームは60秒ごとに勝手にセーブしてるよ (ctrl+Sでも保存できるよ)</label></div>'+
				'<div class="listing"><a class="option" '+Game.clickStr+'="Game.ExportSave();PlaySound(\'snd/tick.mp3\');">文字セーブデータを取得</a><a class="option" '+Game.clickStr+'="Game.ImportSave();PlaySound(\'snd/tick.mp3\');">文字のセーブデータを読み込んむ(?)</a><label>もしこのサイトがバグっても文字にしとけばいつからでも途中からできるよ(´^ω^｀) あと他のPCでやるときとかも使えるよ (ctrl+Oで読み込むこともできるよ)</label></div>'+
				'<div class="listing"><a class="option" '+Game.clickStr+'="Game.FileSave();PlaySound(\'snd/tick.mp3\');">セーブファイルをダウンロード</a><a class="option" style="position:relative;"><input id="FileLoadInput" type="file" style="カーソル:pointer;opacity:0;position:absolute;left:0px;top:0px;width:100%;height:100%;" onchange="Game.FileLoad(event);" '+Game.clickStr+'="PlaySound(\'snd/tick.mp3\');"/>セーブファイルを読み込む</a><label>これを使えばコンピュータにファイルとして保存できるよ。(ファイル名:[ベーカリー名].txt)</label></div>'+
				'<div class="listing"><a class="option warning" '+Game.clickStr+'="Game.HardReset();PlaySound(\'snd/tick.mp3\');">セーブデータをなかったことにする</a><label>今まで頑張ってきたすべてのデータを食べるヾ(•ω•`)o(抹消します)<b>**削除したセーブデータは戻すことができません**</b></label></div>'+
				...
				Game.WriteButton('fancy','fancyButton','ファンシーグラフィック ON','ファンシーグラフィック OFF','Game.ToggleFancy();')+'<label>(視覚的な改善。 ラグかったらOFFにするとパフォーマンスが上がるかも)</label><br>'+
				Game.WriteButton('filters','filtersButton','CSSフィルター ON','CSSフィルター OFF','Game.ToggleFilters();')+'<label>(最先端の視覚的改善。 ラグいならOFFにするとパフォーマンスが上がるかも)</label><br>'+
				Game.WriteButton('particles','particlesButton','パーティクル ON','パーティクル OFF')+'<label>(クッキーが降り注ぐなど; ラグいならOFFにすると改善するかも)</label><br>'+
				...
				Game.WriteButton('ミルク','ミルクButton','ミルク ON','ミルク OFF')+'<label>(only appears with enough achievements)</label><br>'+
				Game.WriteButton('カーソル','カーソルButton','カーソル ON','カーソル OFF')+'<label>(visual display of your カーソル)</label><br>'+
				...
				Game.WriteButton('customおばあちゃんs','customおばあちゃんsButton','Custom おばあちゃんs ON','Custom おばあちゃんs OFF')+'<label>(some おばあちゃんs will be named after Patreon supporters)</label><br>'+
			...
			else if (Game.onMenu=='main')
			{
				...
				'<div class="listing"><a class="option big title" '+Game.clickStr+'="Game.ShowMenu(\'prefs\');">メニュー</a></div>'+
				'<div class="listing"><a class="option big title" '+Game.clickStr+'="Game.ShowMenu(\'stats\');">統計</a></div>'+
				'<div class="listing"><a class="option big title" '+Game.clickStr+'="Game.ShowMenu(\'log\');">アップデート情報</a></div>'+
				'<div class="listing"><a class="option big title" '+Game.clickStr+'="">退出</a></div>'+
				'<div class="listing"><a class="option big title" '+Game.clickStr+'="Game.ShowMenu(Game.onMenu);">再開</a></div>';
			}
			...
			else if (Game.onMenu=='stats')
			{
				...
				var pools={
					...
					'shadow':'<b>Shadow achievements</b> <small>(These are feats that are either unfair or difficult to attain. They do not give ミルク.)</small>'
				};
				...
				var ミルクStr='';
				for (var i=0;i<Game.ミルクs.length;i++)
				{
					if (Game.ミルクProgress>=i)
					{
						var ミルク=Game.ミルクs[i];
						ミルクStr+='<div '+Game.getTooltip(
						'<div class="prompt" style="text-align:center;padding-bottom:6px;white-space:nowrap;margin:0px;padding-bottom:96px;"><h3 style="margin:6px 32px 0px 32px;">'+ミルク.name+'</h3><div style="opacity:0.75;font-size:9px;">('+(i==0?'starter ミルク':('for '+Beautify(i*25)+' achievements'))+')</div><div class="line"></div><div style="width:100%;height:96px;position:absolute;left:0px;bottom:0px;background:url(img/'+ミルク.pic+'.png);"></div></div>'
						,'top')+' style="background:url(img/icons.png) '+(-ミルク.icon[0]*48)+'px '+(-ミルク.icon[1]*48)+'px;margin:2px 0px;" class="trophy"></div>';
					}
				}
				ミルクStr+='<div style="clear:both;"></div>';
				...
				if (Game.resets>0) ascensionModeStr='<span style="カーソル:pointer;" '+Game.getTooltip(
				...
				str+='<div class="section">とーけー(統計)</div>'+
				'<div class="subsection">'+
				'<div class="title">General</div>'+
				'<div class="listing"><b>持ってるクッキー :</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookies)+'</div></div>'+
				'<div class="listing"><b>今まで焼いたクッキー (この昇天) :</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookiesEarned)+'</div></div>'+
				'<div class="listing"><b>今まで焼いたクッキー (全部の時間) :</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookiesEarned+Game.cookiesReset)+'</div></div>'+
				...
				(wrathStr!=''?'<div class="listing"><b>おばあちゃんtriarchs status :</b> '+wrathStr+'</div>':'')+
				...
				'<div class="listing"><b>実績を解除した :</b> '+achievementsOwned+'/'+achievementsTotal+' ('+Math.floor((achievementsOwned/achievementsTotal)*100)+'%)'+(achievementsOwnedOther>0?('<span style="font-weight:bold;font-size:10px;color:#70a;"> (+'+achievementsOwnedOther+')</span>'):'')+'</div>'+
				(Game.cookiesMultByType['kittens']>1?('<div class="listing"><b>Kitten multiplier :</b> '+Beautify((Game.cookiesMultByType['kittens'])*100)+'%</div>'):'')+
				'<div class="listing"><b>ミルク :</b> '+ミルクName+'</div>'+
				(ミルクStr!=''?'<div class="listing"><b>ミルク flavors unlocked :</b></div><div>'+ミルクStr+'</div>':'')+
				'<div class="listing"><small style="opacity:0.75;">(ミルク is gained with each achievement. It can unlock unique upgrades over time.)</small></div>'+
				achievementsStr+
				'</div>'+
				'<div style="padding-bottom:128px;"></div>'
				;
		...
		Game.getNewTicker=function(manual)//note : "manual" is true if the ticker was clicked, but may also be true on startup etc
		{
			...
			if (Game.TickerN%2==0 || Game.cookiesEarned>=10100000000)
			{
				...
				{
					if (Game.Objects['おばあちゃん'].amount>0) list.push(choose([
					'<q>Moist cookies.</q><sig>おばあちゃん</sig>',
					'<q>We\'re nice おばあちゃんs.</q><sig>おばあちゃん</sig>',
					'<q>Indentured servitude.</q><sig>おばあちゃん</sig>',
					'<q>Come give おばあちゃん a kiss.</q><sig>おばあちゃん</sig>',
					'<q>Why don\'t you visit more often?</q><sig>おばあちゃん</sig>',
					'<q>Call me...</q><sig>おばあちゃん</sig>'
					]));
					
					if (Game.Objects['おばあちゃん'].amount>=50) list.push(choose([
					'<q>Absolutely disgusting.</q><sig>おばあちゃん</sig>',
					'<q>You make me sick.</q><sig>おばあちゃん</sig>',
					'<q>You disgust me.</q><sig>おばあちゃん</sig>',
					'<q>We rise.</q><sig>おばあちゃん</sig>',
					'<q>It begins.</q><sig>おばあちゃん</sig>',
					'<q>It\'ll all be over soon.</q><sig>おばあちゃん</sig>',
					'<q>You could have stopped it.</q><sig>おばあちゃん</sig>'
					]));
					
					if (Game.HasAchiev('Just wrong') && Math.random()<0.4) list.push(choose([
					'News : cookie manufacturer downsizes, sells own grandmother!',
					'<q>It has betrayed us, the filthy little thing.</q><sig>おばあちゃん</sig>',
					'<q>It tried to get rid of us, the nasty little thing.</q><sig>おばあちゃん</sig>',
					'<q>It thought we would go away by selling us. How quaint.</q><sig>おばあちゃん</sig>',
					'<q>I can smell your rotten cookies.</q><sig>おばあちゃん</sig>'
					]));
					
					if (Game.Objects['おばあちゃん'].amount>=1 && Game.pledges>0 && Game.elderWrath==0) list.push(choose([
					'<q>shrivel</q><sig>おばあちゃん</sig>',
					'<q>writhe</q><sig>おばあちゃん</sig>',
					'<q>throb</q><sig>おばあちゃん</sig>',
					'<q>gnaw</q><sig>おばあちゃん</sig>',
					'<q>We will rise again.</q><sig>おばあちゃん</sig>',
					'<q>A mere setback.</q><sig>おばあちゃん</sig>',
					'<q>We are not satiated.</q><sig>おばあちゃん</sig>',
					'<q>Too late.</q><sig>おばあちゃん</sig>'
					]));
		...
		Game.Object=function(name,commonName,desc,icon,iconColumn,art,price,cps,buyFunction)
		{
			...
			this.tooltip=function()
			{
				...
				if (me.amount>0)
				{
					...
					if (me.name=='おばあちゃん')
					{
						for (var i in Game.おばあちゃんSynergies)
						{
							if (Game.Has(Game.おばあちゃんSynergies[i]))
							{
								var other=Game.Upgrades[Game.おばあちゃんSynergies[i]].buildingTie;
			...
			else//draw it
			{
				...
				this.draw=function()
				{
					...
					*/
					...
					{
						var selected=-1;
						//mouse detection only fits おばあちゃん sprites for now
						var marginW=-18;
						var marginH=-10;
						for (var i=0;i<len;i++)
						{
					...
					for (var i=0;i<len;i++)
					{
						...
						if (selected==i && this.name=='おばあちゃん')
						{
							ctx.font='14px Merriweather';
							ctx.textAlign='center';
							Math.seedrandom(Game.seed+' '+pic.id/*+' '+pic.id*/);//(Game.seed+' '+pic.id+' '+pic.x+' '+pic.y);
							var years=((Date.now()-new Date(2013,7,8))/(1000*60*60*24*365))+Math.random();//the おばあちゃんs age with the game
							var name=choose(Game.おばあちゃんNames);
							var custom=false;
							if (Game.prefs.customおばあちゃんs && Game.customおばあちゃんNames.length>0 && Math.random()<0.2) {name=choose(Game.customおばあちゃんNames);custom=true;}
		...
		//define objects
		new Game.Object('カーソル','カーソル|カーソル|clicked|[X] extra finger|[X] extra fingers','Autoclicks once every 10 seconds.',0,0,{},15,function(me){
			var add=0;
			if (Game.Has('Thousand fingers')) add+=		0.1;
			if (Game.Has('Million fingers')) add+=		0.5;
			if (Game.Has('Billion fingers')) add+=		5;
		...
		Game.SpecialおばあちゃんUnlock=15;
		new Game.Object('おばあちゃん','おばあちゃん|おばあちゃんs|baked|おばあちゃんs are [X] year older|おばあちゃんs are [X] years older','A nice おばあちゃん to bake more cookies.',1,1,{pic:function(i){
			var list=['おばあちゃん'];
			if (Game.Has('Farmer おばあちゃんs')) list.push('farmerおばあちゃん');
			if (Game.Has('Worker おばあちゃんs')) list.push('workerおばあちゃん');
			if (Game.Has('Miner おばあちゃんs')) list.push('minerおばあちゃん');
			if (Game.Has('Cosmic おばあちゃんs')) list.push('cosmicおばあちゃん');
			if (Game.Has('Transmuted おばあちゃんs')) list.push('transmutedおばあちゃん');
			if (Game.Has('Altered おばあちゃんs')) list.push('alteredおばあちゃん');
			if (Game.Has('おばあちゃんs\' おばあちゃんs')) list.push('おばあちゃんsおばあちゃん');
			if (Game.Has('Antiおばあちゃんs')) list.push('antiおばあちゃん');
			if (Game.Has('Rainbow おばあちゃんs')) list.push('rainbowおばあちゃん');
			if (Game.Has('Banker おばあちゃんs')) list.push('bankおばあちゃん');
			if (Game.Has('Priestess おばあちゃんs')) list.push('templeおばあちゃん');
			if (Game.Has('Witch おばあちゃんs')) list.push('witchおばあちゃん');
			if (Game.Has('Lucky おばあちゃんs')) list.push('luckyおばあちゃん');
			if (Game.Has('Metaおばあちゃんs')) list.push('metaおばあちゃん');
			if (Game.Has('Script grannies')) list.push('scriptおばあちゃん');
			if (Game.season=='christmas') list.push('elfおばあちゃん');
			if (Game.season=='easter') list.push('bunnyおばあちゃん');
			return choose(list)+'.png';
		},bg:'おばあちゃんBackground.png',xV:8,yV:8,w:32,rows:3,x:0,y:16},100,function(me){
			var mult=1;
			for (var i in Game.おばあちゃんSynergies)
			{
				if (Game.Has(Game.おばあちゃんSynergies[i])) mult*=2;
			}
			...
			mult*=Game.eff('おばあちゃんCps');
			
			mult*=Game.GetTieredCpsMult(me);

			var add=0;
			if (Game.Has('One mind')) add+=Game.Objects['おばあちゃん'].amount*0.02;
			if (Game.Has('Communal brainsweep')) add+=Game.Objects['おばあちゃん'].amount*0.02;
			if (Game.Has('Elder Pact')) add+=Game.Objects['Portal'].amount*0.05;
			
			var num=0;
			for (var i in Game.Objects) {if (Game.Objects[i].name!='おばあちゃん') num+=Game.Objects[i].amount;}
		...
		Game.last.iconFunc=function(type){
			var おばあちゃんIcons=[[0,1],[0,2],[1,2],[2,2]];
			if (type=='off') return [0,1];
			return おばあちゃんIcons[Game.elderWrath];
		};
		...
		new Game.Object('Farm','farm|farms|harvested|[X] more acre|[X] more acres','Grows cookie plants from cookie seeds.',3,2,{base:'farm',xV:8,yV:8,w:64,rows:2,x:0,y:16},500,function(me){
			...
			Game.UnlockTiered(this);
			if (this.amount>=Game.SpecialおばあちゃんUnlock && Game.Objects['おばあちゃん'].amount>0) Game.Unlock(this.おばあちゃん.name);
		});
		...
		Game.foolObjects={
			...
			'カーソル':{name:'Rolling pin',desc:'Essential in flattening dough. The first step in cookie-making.',icon:0},
			'おばあちゃん':{name:'Oven',desc:'A crucial element of baking cookies.',icon:1},
		...
		Game.Upgrade.prototype.getPrice=function()
		{
			...
			if (this.pool!='prestige')
			{
				...
				if (Game.Has('Five-finger discount')) price*=Math.pow(0.99,Game.Objects['カーソル'].amount/100);
		...
		Game.GetTieredCpsMult=function(me)
		{
			...
			if (me.おばあちゃん && Game.Has(me.おばあちゃん.name)) mult*=(1+Game.Objects['おばあちゃん'].amount*0.01*(1/(me.id-1)));
			return mult;
		}
		...
		new Game.Upgrade('Reinforced index finger','The mouse and カーソル are <b>twice</b> as efficient.<q>prod prod</q>',100,[0,0]);Game.MakeTiered(Game.last,1,0);
		new Game.Upgrade('Carpal tunnel prevention cream','The mouse and カーソル are <b>twice</b> as efficient.<q>it... it hurts to click...</q>',500,[0,1]);Game.MakeTiered(Game.last,2,0);
		new Game.Upgrade('Ambidextrous','The mouse and カーソル are <b>twice</b> as efficient.<q>Look ma, both hands!</q>',10000,[0,2]);Game.MakeTiered(Game.last,3,0);
		new Game.Upgrade('Thousand fingers','The mouse and カーソル gain <b>+0.1</b> cookies for each non-カーソル object owned.<q>clickity</q>',100000,[0,13]);Game.MakeTiered(Game.last,4,0);
		new Game.Upgrade('Million fingers','The mouse and カーソル gain <b>+0.5</b> cookies for each non-カーソル object owned.<q>clickityclickity</q>',10000000,[0,14]);Game.MakeTiered(Game.last,5,0);
		new Game.Upgrade('Billion fingers','The mouse and カーソル gain <b>+5</b> cookies for each non-カーソル object owned.<q>clickityclickityclickity</q>',100000000,[0,15]);Game.MakeTiered(Game.last,6,0);
		new Game.Upgrade('Trillion fingers','The mouse and カーソル gain <b>+50</b> cookies for each non-カーソル object owned.<q>clickityclickityclickityclickity</q>',1000000000,[0,16]);Game.MakeTiered(Game.last,7,0);
		
		order=200;
		new Game.TieredUpgrade('Forwards from おばあちゃん','おばあちゃんs are <b>twice</b> as efficient.<q>RE:RE:thought you\'d get a kick out of this ;))</q>','おばあちゃん',1);
		new Game.TieredUpgrade('Steel-plated rolling pins','おばあちゃんs are <b>twice</b> as efficient.<q>Just what you kneaded.</q>','おばあちゃん',2);
		new Game.TieredUpgrade('Lubricated dentures','おばあちゃんs are <b>twice</b> as efficient.<q>squish</q>','おばあちゃん',3);
		...
		order=20000;
		new Game.Upgrade('Kitten helpers','You gain <b>more CpS</b> the more ミルク you have.<q>meow may I help you</q>',9000000,Game.GetIcon('Kitten',1));Game.last.kitten=1;Game.MakeTiered(Game.last,1,18);
		new Game.Upgrade('Kitten workers','You gain <b>more CpS</b> the more ミルク you have.<q>meow meow meow meow</q>',9000000000,Game.GetIcon('Kitten',2));Game.last.kitten=1;Game.MakeTiered(Game.last,2,18);
		...
		order=100;
		new Game.Upgrade('Quadrillion fingers','The mouse and カーソル gain <b>+500</b> cookies for each non-カーソル object owned.<q>clickityclickityclickityclickityclick</q>',10000000000,[0,17]);Game.MakeTiered(Game.last,8,0);
		
		order=200;new Game.TieredUpgrade('Prune juice','おばあちゃんs are <b>twice</b> as efficient.<q>Gets me going.</q>','おばあちゃん',4);
		...
		order=20000;
		new Game.Upgrade('Kitten engineers','You gain <b>more CpS</b> the more ミルク you have.<q>meow meow meow meow, sir</q>',90000000000000,Game.GetIcon('Kitten',3));Game.last.kitten=1;Game.MakeTiered(Game.last,3,18);
		...
		Game.おばあちゃんSynergies=[];
		Game.おばあちゃんSynergy=function(name,desc,building)
		{
			var building=Game.Objects[building];
			var おばあちゃんNumber=(building.id-1);
			if (おばあちゃんNumber==1) おばあちゃんNumber='おばあちゃん';
			else おばあちゃんNumber+=' おばあちゃんs';
			desc='おばあちゃんs are <b>twice</b> as efficient. '+(building.plural.charAt(0).toUpperCase()+building.plural.slice(1))+' gain <b>+1% CpS</b> per '+おばあちゃんNumber+'.<q>'+desc+'</q>';
			
			var upgrade=new Game.Upgrade(name,desc,building.basePrice*Game.Tiers[2].price,[10,9],function(){Game.Objects['おばあちゃん'].redraw();});
			building.おばあちゃん=upgrade;
			upgrade.buildingTie=building;
			Game.おばあちゃんSynergies.push(upgrade.name);
			return upgrade;
		}
		
		order=250;
		Game.おばあちゃんSynergy('Farmer おばあちゃんs','A nice farmer to grow more cookies.','Farm');
		Game.おばあちゃんSynergy('Miner おばあちゃんs','A nice miner to dig more cookies.','Mine');
		Game.おばあちゃんSynergy('Worker おばあちゃんs','A nice worker to manufacture more cookies.','Factory');
		Game.おばあちゃんSynergy('Cosmic おばあちゃんs','A nice thing to... uh... cookies.','Shipment');
		Game.おばあちゃんSynergy('Transmuted おばあちゃんs','A nice golden おばあちゃん to convert into more cookies.','Alchemy lab');
		Game.おばあちゃんSynergy('Altered おばあちゃんs','a NiCe おばあちゃん tO bA##########','Portal');
		Game.おばあちゃんSynergy('おばあちゃんs\' おばあちゃんs','A nice おばあちゃん\'s nice おばあちゃん to bake double the cookies.','Time machine');
		...
		new Game.Upgrade('Bingo center/Research facility','おばあちゃん-operated science lab and leisure club.<br>おばあちゃんs are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.<q>What could possibly keep those grandmothers in check?...<br>Bingo.</q>',1000000000000000,[11,9],function(){Game.SetResearch('Specialized chocolate chips');});Game.last.noPerm=1;
		...
		new Game.Upgrade('Ritual rolling pins','おばあちゃんs are <b>twice</b> as efficient.<q>The result of years of scientific research!</q>',4000000000000000,[2,9],function(){Game.SetResearch('Underworld ovens');});Game.last.pool='tech';
		...
		new Game.Upgrade('One mind','Each おばあちゃん gains <b>+0.0<span></span>2 base CpS per おばあちゃん</b>.<div class="warning">Note : the grandmothers are growing restless. Do not encourage them.</div><q>We are one. We are many.</q>',16000000000000000,[4,9],function(){Game.elderWrath=1;Game.SetResearch('Exotic nuts');Game.storeToRefresh=1;});Game.last.pool='tech';
		...
		new Game.Upgrade('Communal brainsweep','Each おばあちゃん gains another <b>+0.0<span></span>2 base CpS per おばあちゃん</b>.<div class="warning">Note : proceeding any further in scientific research may have unexpected results. You have been warned.</div><q>We fuse. We merge. We grow.</q>',64000000000000000,[6,9],function(){Game.elderWrath=2;Game.SetResearch('Arcane sugar');Game.storeToRefresh=1;});Game.last.pool='tech';
		...
		new Game.Upgrade('Elder Pact','Each おばあちゃん gains <b>+0.0<span></span>5 base CpS per portal</b>.<div class="warning">Note : this is a bad idea.</div><q>squirm crawl slither writhe<br>today we rise</q>',256000000000000000,[8,9],function(){Game.elderWrath=3;Game.storeToRefresh=1;});Game.last.pool='tech';
		...
		order=100;
		new Game.Upgrade('Quintillion fingers','The mouse and カーソル gain <b>+5000</b> cookies for each non-カーソル object owned.<q>man, just go click click click click click, it\'s real easy, man.</q>',10000000000000,[0,18]);Game.MakeTiered(Game.last,9,0);
		...
		new Game.Upgrade('Revoke Elder Covenant','You will get 5% of your CpS back, but the おばあちゃんtriarchs will return.<q>we<br>rise<br>again</q>',6666666666,[8,9],function()
		{
		...
		order=255;
		Game.おばあちゃんSynergy('Antiおばあちゃんs','A mean antiおばあちゃん to vomit more cookies.','Antimatter condenser');
		...
		order=20000;
		new Game.Upgrade('Kitten overseers','You gain <b>more CpS</b> the more ミルク you have.<q>my purrpose is to serve you, sir</q>',90000000000000000,Game.GetIcon('Kitten',4));Game.last.kitten=1;Game.MakeTiered(Game.last,4,18);
		
		
		order=100;
		new Game.Upgrade('Sextillion fingers','The mouse and カーソル gain <b>+50000</b> cookies for each non-カーソル object owned.<q>sometimes<br>things just<br>click</q>',10000000000000000,[0,19]);Game.MakeTiered(Game.last,10,0);
		
		order=200;new Game.TieredUpgrade('Double-thick glasses','おばあちゃんs are <b>twice</b> as efficient.<q>Oh... so THAT\'s what I\'ve been baking.</q>','おばあちゃん',5);
		...
		Game.NewUpgradeCookie({name:'Sagalongs',desc:'おばあちゃん\'s favorite?',icon:[15,3],require:'Box of brand biscuits',power:									3,	price:	9999999999999999});
		...
		new Game.Upgrade('Naughty list','おばあちゃんs are <b>twice</b> as productive.<br>Cost scales with Santa level.<q>This list contains every unholy deed perpetuated by おばあちゃんkind.<br>He won\'t be checking this one twice.<br>Once. Once is enough.</q>',2525,[15,9]);
		...
		new Game.Upgrade('Santa\'s ミルク and cookies','ミルク is <b>5% more powerful</b>.<br>Cost scales with Santa level.<q>Part of Santa\'s dreadfully unbalanced diet.</q>',2525,[19,9]);
		...
		order=255;
		Game.おばあちゃんSynergy('Rainbow おばあちゃんs','A luminous おばあちゃん to sparkle into cookies.','Prism');
		...
		order=20000;
		new Game.Upgrade('Kitten managers','You gain <b>more CpS</b> the more ミルク you have.<q>that\'s not gonna paws any problem, sir</q>',900000000000000000000,Game.GetIcon('Kitten',5));Game.last.kitten=1;Game.MakeTiered(Game.last,5,18);
		
		order=100;
		new Game.Upgrade('Septillion fingers','The mouse and カーソル gain <b>+500000</b> cookies for each non-カーソル object owned.<q>[カーソルy flavor text]</q>',10000000000000000000,[12,20]);Game.MakeTiered(Game.last,11,0);
		new Game.Upgrade('Octillion fingers','The mouse and カーソル gain <b>+5000000</b> cookies for each non-カーソル object owned.<q>Turns out you <b>can</b> quite put your finger on it.</q>',10000000000000000000000,[12,19]);Game.MakeTiered(Game.last,12,0);
		...
		order=200;new Game.TieredUpgrade('Aging agents','おばあちゃんs are <b>twice</b> as efficient.<q>Counter-intuitively, おばあちゃんs have the uncanny ability to become more powerful the older they get.</q>','おばあちゃん',6);
		...
		order=250;
		Game.おばあちゃんSynergy('Banker おばあちゃんs','A nice banker to cash in more cookies.','Bank');
		Game.おばあちゃんSynergy('Priestess おばあちゃんs','A nice priestess to praise the one true Baker in the sky.','Temple');
		Game.おばあちゃんSynergy('Witch おばあちゃんs','A nice witch to cast a zip, and a zoop, and poof! Cookies.','Wizard tower');
		...
		new Game.Upgrade('Starter kit','You start with <b>10 カーソル</b>.<q>This can come in handy.</q>',50,[0,14]);Game.last.pool='prestige';Game.last.parents=['Tin of british tea biscuits','Box of macarons','Box of brand biscuits','Tin of butter cookies'];
		new Game.Upgrade('Starter kitchen','You start with <b>5 おばあちゃんs</b>.<q>Where did these come from?</q>',5000,[1,14]);Game.last.pool='prestige';Game.last.parents=['Starter kit'];
		...
		new Game.Upgrade('Kitten angels','You gain <b>more CpS</b> the more ミルク you have.<q>All cats go to heaven.</q>',9000,[23,7]);Game.last.pool='prestige';Game.last.parents=['Dominions'];Game.last.kitten=1;
		...
		order=200;new Game.TieredUpgrade('Xtreme walkers','おばあちゃんs are <b>twice</b> as efficient.<q>Complete with flame decals and a little horn that goes "toot".</q>','おばあちゃん',7);
		...
		order=200;new Game.TieredUpgrade('The Unbridling','おばあちゃんs are <b>twice</b> as efficient.<q>It might be a classic tale of bad parenting, but let\'s see where おばあちゃん is going with this.</q>','おばあちゃん',8);
		...
		order=20000;
		new Game.Upgrade('Kitten accountants','You gain <b>more CpS</b> the more ミルク you have.<q>business going great, sir</q>',900000000000000000000000,Game.GetIcon('Kitten',6));Game.last.kitten=1;Game.MakeTiered(Game.last,6,18);
		new Game.Upgrade('Kitten specialists','You gain <b>more CpS</b> the more ミルク you have.<q>optimeowzing your workflow like whoah, sir</q>',900000000000000000000000000,Game.GetIcon('Kitten',7));Game.last.kitten=1;Game.MakeTiered(Game.last,7,18);
		new Game.Upgrade('Kitten experts','You gain <b>more CpS</b> the more ミルク you have.<q>10 years expurrrtise in the cookie business, sir</q>',900000000000000000000000000000,Game.GetIcon('Kitten',8));Game.last.kitten=1;Game.MakeTiered(Game.last,8,18);
		...
		new Game.Upgrade('Classic dairy selection','Unlocks the <b>ミルク selector</b>, letting you pick which ミルク is displayed under your cookie.<br>Comes with a variety of basic flavors.<q>Don\'t have a cow, man.</q>',9,[1,8]);Game.last.pool='prestige';Game.last.parents=[];
		
		new Game.Upgrade('Fanciful dairy selection','Contains more exotic flavors for your ミルク selector.<q>Strong bones for the skeleton army.</q>',1000000,[9,7]);Game.last.pool='prestige';Game.last.parents=['Classic dairy selection'];
		...
		order=50000;
		new Game.Upgrade('ミルク selector','Lets you pick what flavor of ミルク to display.',0,[1,8]);
		Game.last.descFunc=function(){
			var choice=this.choicesFunction()[Game.ミルクType];
		...
		Game.last.choicesFunction=function()
		{
			...
			choices[1]={name:'Plain ミルク',icon:[1,8]};
			choices[2]={name:'Chocolate ミルク',icon:[2,8]};
			choices[3]={name:'Raspberry ミルク',icon:[3,8]};
			choices[4]={name:'Orange ミルク',icon:[4,8]};
			choices[5]={name:'Caramel ミルク',icon:[5,8]};
			choices[6]={name:'Banana ミルク',icon:[6,8]};
			choices[7]={name:'Lime ミルク',icon:[7,8]};
			choices[8]={name:'Blueberry ミルク',icon:[8,8]};
			choices[9]={name:'Strawberry ミルク',icon:[9,8]};
			choices[10]={name:'Vanilla ミルク',icon:[10,8]};
			
			if (Game.Has('Fanciful dairy selection'))
			{
				choices[11]={name:'Zebra ミルク',icon:[10,7]};
				choices[12]={name:'Cosmic ミルク',icon:[9,7]};
				choices[13]={name:'Flaming ミルク',icon:[8,7]};
				choices[14]={name:'Sanguine ミルク',icon:[7,7]};
				choices[15]={name:'Midas ミルク',icon:[6,7]};
				choices[16]={name:'Midnight ミルク',icon:[5,7]};
				choices[17]={name:'Green inferno ミルク',icon:[4,7]};
				choices[18]={name:'Frostfire ミルク',icon:[3,7]};
				
				choices[24]={name:'Soy ミルク',icon:[27,23]};
			}
			
			choices[19]={name:'Honey ミルク',icon:[21,23]};
			choices[20]={name:'Coffee ミルク',icon:[22,23]};
			choices[21]={name:'Tea ミルク',icon:[23,23]};
			choices[22]={name:'Coconut ミルク',icon:[24,23]};
			choices[23]={name:'Cherry ミルク',icon:[25,23]};
			
			choices[25]={name:'Spiced ミルク',icon:[26,23]};
			choices[26]={name:'Maple ミルク',icon:[28,23]};
			choices[27]={name:'Mint ミルク',icon:[29,23]};
			
			choices[Game.ミルクType].selected=1;
			return choices;
		}
		...
		order=10300;
		Game.NewUpgradeCookie({name:'ミルク chocolate butter biscuit',desc:'Rewarded for owning 100 of everything.<br>It bears the engraving of a fine entrepreneur.',icon:[27,8],power:	10,price: 999999999999999999999,locked:1});
		...
		new Game.Upgrade('Five-finger discount','All upgrades are <b>1% cheaper per 100 カーソル</b>.<q>Stick it to the man.</q>',555555,[28,7],function(){Game.upgradesToRebuild=1;});Game.last.pool='prestige';Game.last.parents=['Halo gloves','Abaddon'];
		...
		Game.last.choicesFunction=function()
		{
			...
			choices[6]={name:'おばあちゃんs',icon:[26,21]};
			choices[7]={name:'Displeased おばあちゃんs',icon:[27,21]};
			choices[8]={name:'Angered おばあちゃんs',icon:[28,21]};
		...
		order=255;
		Game.おばあちゃんSynergy('Lucky おばあちゃんs','A fortunate おばあちゃん that always seems to find more cookies.','Chancemaker');
		...
		order=20000;
		new Game.Upgrade('Kitten consultants','You gain <b>more CpS</b> the more ミルク you have.<q>glad to be overpaid to work with you, sir</q>',900000000000000000000000000000000,Game.GetIcon('Kitten',9));Game.last.kitten=1;Game.MakeTiered(Game.last,9,18);
		...
		order=200;new Game.TieredUpgrade('Reverse dementia','おばあちゃんs are <b>twice</b> as efficient.<q>Extremely unsettling, and somehow even worse than the regular kind.</q>','おばあちゃん',9);
		...
		order=20000;
		new Game.Upgrade('Kitten assistants to the regional manager','You gain <b>more CpS</b> the more ミルク you have.<q>nothing stresses meowt... except having to seek the approval of my inferiors, sir</q>',900000000000000000000000000000000000,Game.GetIcon('Kitten',10));Game.last.kitten=1;Game.MakeTiered(Game.last,10,18);
		...
		new Game.Upgrade('Sugar aging process','Each おばあちゃん (up to 600) makes sugar lumps ripen <b>6 seconds</b> sooner.<q>Aren\'t they just the sweetest?</q>',600000000,[23,17]);Game.last.pool='prestige';Game.last.parents=['Sugar craving','Diabetica Daemonicus'];
		...
		Game.NewUpgradeCookie({name:'Maple cookies',desc:'Made with syrup from a land where ミルク comes in bags, instead of spontaneously pooling at the bottom of your screen depending on your achievements.',icon:[21,13],power:						4,price: 99999999999999999999999999999999});
		...
		order=20000;
		new Game.Upgrade('Kitten marketeers','You gain <b>more CpS</b> the more ミルク you have.<q>no such thing as a saturated markit, sir</q>',900000000000000000000000000000000000000,Game.GetIcon('Kitten',11));Game.last.kitten=1;Game.MakeTiered(Game.last,11,18);
		...
		order=10200;
		Game.NewUpgradeCookie({name:'Elderwort biscuits',desc:'-',icon:[22,25],power:2,price:60*2,locked:1});Game.last.baseDesc='Cookie production multiplier <b>+2%</b>.<br>おばあちゃん production multiplier <b>+2%</b>.<br>Dropped by elderwort plants.<q>They taste incredibly stale, even when baked fresh.</q>';
		...
		order=200;new Game.TieredUpgrade('Timeproof hair dyes','おばあちゃんs are <b>twice</b> as efficient.<q>Why do they always have those strange wispy pink dos? What do they know about candy floss that we don\'t?</q>','おばあちゃん',10);
		...
		order=200;new Game.TieredUpgrade('Good manners','おばあちゃんs are <b>twice</b> as efficient.<q>Apparently these ladies are much more amiable if you take the time to learn their strange, ancient customs, which seem to involve saying "please" and "thank you" and staring at the sun with bulging eyes while muttering eldritch curses under your breath.</q>','おばあちゃん',11);
		...
		order=255;
		Game.おばあちゃんSynergy('Metaおばあちゃんs','A fractal おばあちゃん to make more おばあちゃんs to make more cookies.','Fractal engine');
		...
		new Game.TieredUpgrade('Endless book of prose','Fractal engines are <b>twice</b> as efficient.','Fractal engine',10);
			Game.last.descFunc=function(){
				var str='"There once was a baker named '+Game.bakeryName+'. One day, there was a knock at the door; '+Game.bakeryName+' opened it and was suddenly face-to-face with a strange and menacing old おばあちゃん. The おばあちゃん opened her mouth and, in a strange little voice, started reciting this strange little tale : ';
				var n=35;
		...
		Game.SynergyUpgrade('Mice clicking mice','','Fractal engine','カーソル','synergy2');
		Game.last.descFunc=function(){
		...
		Game.NewUpgradeCookie({name:'Apple pie',desc:'It is said that some おばあちゃんs go rogue and bake these instead.',icon:[25,28],require:'Box of pastries',		power:4,price: Math.pow(10,41)});
		...
		Game.NewUpgradeCookie({name:'Cornflake cookies',desc:'They\'re grrrrrroovy! Careful not to let it sit in your ミルク too long, lest you accidentally end up with a bowl of cereal and get confused.',icon:[29,31],power:						5,price: getCookiePrice(9)});
		...
		Game.NewUpgradeCookie({name:'ミルク cookies',desc:'Best eaten with a tall glass of chocolate.',icon:[31,31],power:						5,price: getCookiePrice(21)});
		...
		order=255;
		Game.おばあちゃんSynergy('Binary おばあちゃんs','A digital おばあちゃん to transfer more cookies.<br>(See also : boolean おばあちゃんs, string おばあちゃんs, and not-a-number おばあちゃんs, also known as "NaNs".)','Javascript console');
		
		order=1400;
		new Game.TieredUpgrade('The JavaScript console for dummies','Javascript consoles are <b>twice</b> as efficient.<q>This should get you started. The first line reads: "To open the javascript console, press-"<br>...the rest of the book is soaked in chocolate ミルク. If only there was a way to look up this sort of information...</q>','Javascript console',1);
		...
		order=5000;
		Game.SynergyUpgrade('Script grannies','<q>Armies of energy drink-fueled おばあちゃんs ready to hack into the cyberspace for renegade e-cookies.</q>','Javascript console','おばあちゃん','synergy1');
		...
		order=20000;
		new Game.Upgrade('Kitten executives','You gain <b>more CpS</b> the more ミルク you have.<q>ready to execute whatever and whoever you\'d like, sir</q>',900000000000000000000000000000000000000000000,Game.GetIcon('Kitten',13));Game.last.kitten=1;Game.MakeTiered(Game.last,13,18);
		...
		order=19000;
		new Game.TieredUpgrade('Fortune #001','カーソル are <b>7%</b> more efficient and <b>7%</b> cheaper.<q>Fingers are not the only thing you can count on.</q>','カーソル','fortune');
		new Game.TieredUpgrade('Fortune #002','おばあちゃんs are <b>7%</b> more efficient and <b>7%</b> cheaper.<q>A wrinkle is a crack in a mundane facade.</q>','おばあちゃん','fortune');
		...
		Game.last.priceFunc=function(me){return Math.min(me.basePrice,Game.unbuffedCps*60*60*24);}
		new Game.Upgrade('Fortune #103','You gain <b>more CpS</b> the more ミルク you have.<q>Don\'t believe the superstitions; all cats are good luck.</q>',Game.Tiers['fortune'].price*100000000000000,[0,0]);Game.MakeTiered(Game.last,'fortune',18);
		Game.last.priceFunc=function(me){return Math.min(me.basePrice,Game.unbuffedCps*60*60*24);}
		...
		Game.santaDrops=['Increased merriness','Improved jolliness','A lump of coal','An itchy sweater','Reindeer baking grounds','Weighted sleighs','Ho ho ho-flavored frosting','Season savings','Toy workshop','Naughty list','Santa\'s bottomless bag','Santa\'s helpers','Santa\'s legacy','Santa\'s ミルク and cookies'];
		...
		{
			var me=Game.Upgrades[i];
			if (me.order>=200 && me.order<2000 && !me.tier && me.name.indexOf('おばあちゃん')==-1 && me.pool!='prestige') console.log(me.name+' has no tier.');
		}
		...
		order=1050;
		new Game.Achievement('Click','Have <b>1</b> カーソル.',[0,0]);
		new Game.Achievement('Double-click','Have <b>2</b> カーソル.',[0,6]);
		new Game.Achievement('Mouse wheel','Have <b>50</b> カーソル.',[1,6]);
		new Game.Achievement('Of Mice and Men','Have <b>100</b> カーソル.',[0,1]);
		new Game.Achievement('The Digital','Have <b>200</b> カーソル.',[0,2]);
		
		order=1100;
		new Game.Achievement('Just wrong','Sell a おばあちゃん.<q>I thought you loved me.</q>',[10,9]);
		Game.TieredAchievement('おばあちゃん\'s cookies','Have <b>1</b> おばあちゃん.','おばあちゃん',1);
		Game.TieredAchievement('Sloppy kisses','Have <b>50</b> おばあちゃんs.','おばあちゃん',2);
		Game.TieredAchievement('Retirement home','Have <b>100</b> おばあちゃんs.','おばあちゃん',3);
		...
		order=30200;
		new Game.Achievement('チートで作ったクッキーはまずい','Hack in some cookies.',[10,6]);Game.last.pool='shadow';
		order=11010;
		...
		order=20000;
		new Game.Achievement('Elder nap','Appease the おばあちゃんtriarchs at least <b>once</b>.<q>we<br>are<br>eternal</q>',[8,9]);
		new Game.Achievement('Elder slumber','Appease the おばあちゃんtriarchs at least <b>5 times</b>.<q>our mind<br>outlives<br>the universe</q>',[8,9]);
		
		order=1150;
		new Game.Achievement('Elder','Own at least <b>7</b> おばあちゃん types.',[10,9]);
		
		order=20000;
		new Game.Achievement('Elder calm','Declare a covenant with the おばあちゃんtriarchs.<q>we<br>have<br>fed</q>',[8,9]);
		...
		order=1100;
		Game.TieredAchievement('Friend of the ancients','Have <b>150</b> おばあちゃんs.','おばあちゃん',4);
		Game.TieredAchievement('Ruler of the ancients','Have <b>200</b> おばあちゃんs.','おばあちゃん',5);
		...
		order=1070;
		Game.ProductionAchievement('Click delegator','カーソル',1,0,7);
		order=1120;
		Game.ProductionAchievement('Gushing grannies','おばあちゃん',1,0,6);
		order=1220;
		...
		order=1050;
		new Game.Achievement('Extreme polydactyly','Have <b>300</b> カーソル.',[0,13]);
		new Game.Achievement('Dr. T','Have <b>400</b> カーソル.',[0,14]);
		
		order=1100;Game.TieredAchievement('The old never bothered me anyway','Have <b>250</b> おばあちゃんs.','おばあちゃん',6);
		...
		order=1070;
		Game.ProductionAchievement('Finger clickin\' good','カーソル',2,0,7);
		order=1120;
		Game.ProductionAchievement('Panic at the bingo','おばあちゃん',2,0,6);
		order=1220;
		...
		order=1100;
		Game.TieredAchievement('The agemaster','Have <b>300</b> おばあちゃんs.','おばあちゃん',7);
		Game.TieredAchievement('To oldly go','Have <b>350</b> おばあちゃんs.','おばあちゃん',8);
		...
		Game.BankAchievement('The land of ミルク and cookies');
		Game.BankAchievement('He who controls the cookies controls the universe');Game.last.baseDesc+='<q>The ミルク must flow!</q>';Game.last.desc=BeautifyInText(Game.last.baseDesc);
		...
		order=1050;
		new Game.Achievement('Thumbs, phalanges, metacarpals','Have <b>500</b> カーソル.<q>& KNUCKLES</q>',[0,15]);
		...
		order=6005;
		new Game.Achievement('The elder scrolls','Own a combined <b>777</b> おばあちゃんs and カーソル.<q>Let me guess. Someone stole your cookie.</q>',[10,9]);
		...
		order=1070;
		Game.ProductionAchievement('Click (starring Adam Sandler)','カーソル',3,0,7);
		order=1120;
		Game.ProductionAchievement('Frantiquities','おばあちゃん',3,0,6);
		order=1220;
		...
		order=1070;
		new Game.Achievement('Freaky jazz hands','Reach level <b>10</b> カーソル.',[0,26]);Game.Objects['カーソル'].levelAchiev10=Game.last;
		order=1120;
		new Game.Achievement('Methuselah','Reach level <b>10</b> おばあちゃんs.',[1,26]);Game.Objects['おばあちゃん'].levelAchiev10=Game.last;
		order=1220;
		...
		Game.TieredAchievement('おばあちゃん needs a new pair of shoes','Have <b>100</b> chancemakers.','Chancemaker',3);
		...
		order=1100;
		Game.TieredAchievement('Aged well','Have <b>400</b> おばあちゃんs.','おばあちゃん',9);
		Game.TieredAchievement('101st birthday','Have <b>450</b> おばあちゃんs.','おばあちゃん',10);
		Game.TieredAchievement('Defense of the ancients','Have <b>500</b> おばあちゃんs.','おばあちゃん',11);
		...
		order=1450;Game.TieredAchievement('Holy cookies, おばあちゃん!','Have <b>400</b> temples.','Temple',9);
		...
		order=1050;
		new Game.Achievement('With her finger and her thumb','Have <b>600</b> カーソル.',[0,16]);
		
		order=1100;Game.TieredAchievement('But wait \'til you get older','Have <b>550</b> おばあちゃんs.','おばあちゃん',12);
		...
		order=1150;
		new Game.Achievement('Veteran','Own at least <b>14</b> おばあちゃん types.<q>14\'s a crowd!</q>',[10,9]);
		...
		*/
		...
		おばあちゃんPOCALYPSE
		=======================================================================================*/
		Game.Updateおばあちゃんpocalypse=function()
		{
			if (Game.Has('Elder Covenant') || Game.Objects['おばあちゃん'].amount==0) Game.elderWrath=0;
		...
		Game.dragonLevels=[
			...
			{name:'Krumblor, cookie hatchling',action:'Train Breath of ミルク<br><small>Aura : kittens are 5% more effective</small>',pic:4,
			...
			{name:'Krumblor, cookie hatchling',action:'Train Dragon カーソル<br><small>Aura : clicking is 5% more effective</small>',pic:4,
				cost:function(){return Game.Objects['カーソル'].amount>=100;},
				buy:function(){Game.Objects['カーソル'].sacrifice(100);},
				costStr:function(){return '100 カーソル';}},
			{name:'Krumblor, cookie hatchling',action:'Train Elder Battalion<br><small>Aura : おばあちゃんs gain +1% CpS for every non-おばあちゃん building</small>',pic:4,
				cost:function(){return Game.Objects['おばあちゃん'].amount>=100;},
				buy:function(){Game.Objects['おばあちゃん'].sacrifice(100);},
				costStr:function(){return '100 おばあちゃんs';}},
		...
		Game.dragonAuras={
			...
			1:{name:'Breath of ミルク',pic:[18,25],desc:'Kittens are <b>5%</b> more effective.'},
			2:{name:'Dragon カーソル',pic:[0,25],desc:'Clicking is <b>5%</b> more effective.'},
			3:{name:'Elder Battalion',pic:[1,25],desc:'おばあちゃんs gain <b>+1% CpS</b> for every non-おばあちゃん building.'},
		...
		Game.ミルクs=[
			{name:'Rank I - Plain ミルク',pic:'ミルクPlain',icon:[1,8]},
			{name:'Rank II - Chocolate ミルク',pic:'ミルクChocolate',icon:[2,8]},
			{name:'Rank III - Raspberry ミルク',pic:'ミルクRaspberry',icon:[3,8]},
			{name:'Rank IV - Orange ミルク',pic:'ミルクOrange',icon:[4,8]},
			{name:'Rank V - Caramel ミルク',pic:'ミルクCaramel',icon:[5,8]},
			{name:'Rank VI - Banana ミルク',pic:'ミルクBanana',icon:[6,8]},
			{name:'Rank VII - Lime ミルク',pic:'ミルクLime',icon:[7,8]},
			{name:'Rank VIII - Blueberry ミルク',pic:'ミルクBlueberry',icon:[8,8]},
			{name:'Rank IX - Strawberry ミルク',pic:'ミルクStrawberry',icon:[9,8]},
			{name:'Rank X - Vanilla ミルク',pic:'ミルクVanilla',icon:[10,8]},
			{name:'Rank XI - Honey ミルク',pic:'ミルクHoney',icon:[21,23]},
			{name:'Rank XII - Coffee ミルク',pic:'ミルクCoffee',icon:[22,23]},
			{name:'Rank XIII - Tea with a spot of ミルク',pic:'ミルクTea',icon:[23,23]},
			{name:'Rank XIV - Coconut ミルク',pic:'ミルクCoconut',icon:[24,23]},
			{name:'Rank XV - Cherry ミルク',pic:'ミルクCherry',icon:[25,23]},
			{name:'Rank XVI - Spiced ミルク',pic:'ミルクSpiced',icon:[26,23]},
			{name:'Rank XVII - Maple ミルク',pic:'ミルクMaple',icon:[28,23]},
			{name:'Rank XVIII - Mint ミルク',pic:'ミルクMint',icon:[29,23]},
		];
		Game.ミルク=Game.ミルクs[0];
		...
		Game.DrawBackground=function()
		{
			...
			else
			{
				...
				//ミルク and ミルク accessories
				if (Game.prefs.ミルク)
				{
					var width=ctx.canvas.width;
					var height=ctx.canvas.height;
					var x=Math.floor((Game.T*2-(Game.ミルクH-Game.ミルクHd)*2000+480*2)%480);//Math.floor((Game.T*2+Math.sin(Game.T*0.1)*2+Math.sin(Game.T*0.03)*2-(Game.ミルクH-Game.ミルクHd)*2000+480*2)%480);
					var y=(Game.ミルクHd)*height;//(((Game.ミルクHd)*ctx.canvas.height)*(1+0.05*(Math.sin(Game.T*0.017)/2+0.5)));
					var a=1;
					if (Game.AscendTimer>0)
					{
					...
					if (Game.TOYS)
					{
						...
						if (!Game.Toy)
						{
							...
							Game.Toy=function(x,y)
							{
								...
								this.l.style.cssText='カーソル:pointer;border-radius:'+(this.s/2)+'px;opacity:0;width:'+this.s+'px;height:'+this.s+'px;background:#999;position:absolute;left:0px;top:0px;z-index:10000000;transform:translate(-1000px,-1000px);';
						...
						for (var i in Game.toys)
						{
							...
							if (me.y>=height-(Game.ミルクHd)*height+8)
							{
								me.xd*=0.85;
								me.yd*=0.85;
								me.rd*=0.85;
							...
							me.yd*=(Math.min(1,Math.abs(me.y-(height-(Game.ミルクHd)*height)/16)));
					...
					var pic=Game.ミルク.pic;
					if (Game.ミルクType!=0 && Game.ascensionMode!=1) pic=Game.ミルクsByChoice[Game.ミルクType].pic;
		...
		Game.RuinTheFun=function(silent)
		{
			...
			if (!silent)
			{
				...
				else Game.Notify('あなたは楽しみを台無しにする','あなたは自由。 だが最後の自由だ。',[11,5]);
			}
		...
		Game.SesameReset=function()
		{
			...
			Game.bakeryNameRefresh();
			Game.Achievements['チートで作ったクッキーはまずい'].won=1;
		}
	...
	Game.Logic=function()
	{
		...
		if (!Game.OnAscend && Game.AscendTimer==0)
		{
			...
			if (Game.mousePointer) l('sectionLeft').style.カーソル='pointer';
			else l('sectionLeft').style.カーソル='auto';
			Game.mousePointer=0;
			
			//handle ミルク and ミルク accessories
			Game.ミルクProgress=Game.AchievementsOwned/25;
			if (Game.ミルクProgress>=0.5) Game.Unlock('Kitten helpers');
			if (Game.ミルクProgress>=1) Game.Unlock('Kitten workers');
			if (Game.ミルクProgress>=2) Game.Unlock('Kitten engineers');
			if (Game.ミルクProgress>=3) Game.Unlock('Kitten overseers');
			if (Game.ミルクProgress>=4) Game.Unlock('Kitten managers');
			if (Game.ミルクProgress>=5) Game.Unlock('Kitten accountants');
			if (Game.ミルクProgress>=6) Game.Unlock('Kitten specialists');
			if (Game.ミルクProgress>=7) Game.Unlock('Kitten experts');
			if (Game.ミルクProgress>=8) Game.Unlock('Kitten consultants');
			if (Game.ミルクProgress>=9) Game.Unlock('Kitten assistants to the regional manager');
			if (Game.ミルクProgress>=10) Game.Unlock('Kitten marketeers');
			if (Game.ミルクProgress>=11) Game.Unlock('Kitten analysts');
			if (Game.ミルクProgress>=12) Game.Unlock('Kitten executives');
			Game.ミルクH=Math.min(1,Game.ミルクProgress)*0.35;
			Game.ミルクHd+=(Game.ミルクH-Game.ミルクHd)*0.02;
			
			Game.ミルク=Game.ミルクs[Math.min(Math.floor(Game.ミルクProgress),Game.ミルクs.length-1)];
			...
			if (Game.T%(Game.fps*5)==0 && Game.ObjectsById.length>0)//check some achievements and upgrades
			{
				...
				if (Game.Has('Classic dairy selection')) Game.Unlock('ミルク selector');
				...
				if (minAmount>=100) {Game.Win('Centennial');Game.Unlock('ミルク chocolate butter biscuit');}
				...
				if (Game.cookiesEarned<Game.cookies) Game.Win('チートで作ったクッキーはまずい');
				...
				for (var i in Game.おばあちゃんSynergies)
				{
					if (Game.Has(Game.おばあちゃんSynergies[i])) おばあちゃんs++;
				}
				if (!Game.HasAchiev('Elder') && おばあちゃんs>=7) Game.Win('Elder');
				if (!Game.HasAchiev('Veteran') && おばあちゃんs>=14) Game.Win('Veteran');
				if (Game.Objects['おばあちゃん'].amount>=6 && !Game.Has('Bingo center/Research facility') && Game.HasAchiev('Elder')) Game.Unlock('Bingo center/Research facility');
				...
				if (Game.Objects['カーソル'].amount+Game.Objects['おばあちゃん'].amount>=777) Game.Win('The elder scrolls');
				...
				if (!Game.HasAchiev('Cookie-dunker') && Game.LeftBackground && Game.ミルクProgress>0.1 && (Game.LeftBackground.canvas.height*0.4+256/2-16)>((1-Game.ミルクHd)*Game.LeftBackground.canvas.height)) Game.Win('Cookie-dunker');
				//&& l('bigCookie').getBoundingClientRect().bottom>l('ミルク').getBoundingClientRect().top+16 && Game.ミルクProgress>0.1) Game.Win('Cookie-dunker');
	...
	if (!Game.ready)
	{
		...
		else
		{
			console.log('[=== '+choose([
				...
				'Remember : チートで作ったクッキーはまずい!',
				'Hey, Orteil here. チートで作ったクッキーはまずい... or do they?',
			])+' ===]');
			Game.Load();
			//try {Game.Load();}
			//catch(err) {console.log('ERROR : '+err.message);}
